...
namespace CustomerFeedbackSentimentAnalysis
{
    class Program
    {
        private static readonly AzureKeyCredential credentials = new AzureKeyCredential("c36a5760589f4d48a9e18e4196560b04");
        private static readonly Uri endpoint = new Uri("https://feedbackazurewebapp.cognitiveservices.azure.com/");
        ...
        {
            var response = client.RecognizeEntities("I had a wonderful trip last week.");
